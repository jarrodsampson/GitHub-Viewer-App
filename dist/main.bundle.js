...
var DetailUserComponent = (function () {
    ...
    DetailUserComponent.prototype.repoDetails = function (repo) {
        this.router.navigate(['./repositories/details/' + encodeURI(repo.full_name)]);
    };
    ...
    DetailUserComponent.prototype.initTabs = function () {
        this.tabClosed0 = true;
        this.tabClosed1 = true;
        this.tabClosed2 = false;
        this.tabClosed3 = true;
    };
    DetailUserComponent.prototype.openTab = function (tabNumber) {
        if (tabNumber == 0) {
...
// module
exports.push([module.i, "\n\n.emojiImageBox {\n  min-height: 150px;\n}\n\n.emojiImageBox img {\n\n}\n\n\n.emojiContainerBox {\n  min-height:300px;\n}\n\n\n.bannerEmoji {\n  width:100%;\n  height:400px;\n  background:url(" + __webpack_require__(92) + ") top center fixed;\n  background-size:cover;\n  position: relative;\n}\n", ""]);
...
module.exports = "<div class=\"navbar-fixed\">\n  <nav id=\"header\">\n    <div class=\"nav-wrapper black\">\n      <mz-navbar>\n        <a routerLink=\"/home\" class=\"brand-logo topScroll\"><img src=\"assets/images/logo2.png\" /> <span class=\"title-text\">Git App</span></a>\n        <a href=\"#\" data-activates=\"sidenav\" class=\"button-collapse\"><i class=\"material-icons\">menu</i></a>\n        <mz-navbar-item-container [align]=\"'right'\" class=\"nav-wrapper black\">\n          <mz-navbar-item><a routerLink=\"/users\" routerLinkActive=\"active-link\">Users</a></mz-navbar-item>\n          <mz-navbar-item><a routerLink=\"/repositories\" routerLinkActive=\"active-link\">Repositories</a></mz-navbar-item>\n          <mz-navbar-item><a routerLink=\"/organizations\" routerLinkActive=\"active-link\">Organizations</a></mz-navbar-item>\n          <mz-navbar-item><a routerLink=\"/events\" routerLinkActive=\"active-link\">Events</a></mz-navbar-item>\n          <mz-navbar-item><a routerLink=\"/emojis\" routerLinkActive=\"active-link\">Emojis</a></mz-navbar-item>\n          <mz-navbar-item><a class=\"modal-trigger\" id=\"aboutModalTrigger\"><i class=\"material-icons\">info</i></a></mz-navbar-item>\n          <mz-navbar-item><a class=\"waves-effect waves-light btn amber darken-2\" href=\"//github.com/\" target=\"_blank\">More</a></mz-navbar-item>\n        </mz-navbar-item-container>\n      </mz-navbar>\n    </div>\n\n    <mz-sidenav\n      [id]=\"'sidenav'\"\n      [closeOnClick]=\"'true'\">\n      <mz-sidenav-header>\n        <img src=\"assets/images/emoji.jpg\" alt=\"SideImagine\" />\n      </mz-sidenav-header>\n\n      <mz-sidenav-link><a routerLink=\"/users\" routerLinkActive=\"active-link\">Users</a></mz-sidenav-link>\n      <mz-sidenav-link><a routerLink=\"/repositories\" routerLinkActive=\"active-link\">Repositories</a></mz-sidenav-link>\n      <mz-sidenav-link><a routerLink=\"/organizations\" routerLinkActive=\"active-link\">Organizations</a></mz-sidenav-link>\n      <mz-sidenav-link><a routerLink=\"/events\" routerLinkActive=\"active-link\">Events</a></mz-sidenav-link>\n      <mz-sidenav-link><a routerLink=\"/emojis\" routerLinkActive=\"active-link\">Emojis</a></mz-sidenav-link>\n      <mz-sidenav-link><a class=\"modal-trigger\" id=\"aboutModalTrigger2\">About</a></mz-sidenav-link>\n      <mz-sidenav-link><a href=\"//github.com/\" target=\"_blank\">More</a></mz-sidenav-link>\n\n    </mz-sidenav>\n\n  </nav>\n</div>\n\n<router-outlet></router-outlet>\n"
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12\">\n    <h3>Search Results for: {{repo}}</h3>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col s12\">\n    <button (click)=\"goBack()\" class=\"waves-effect waves-light btn black\">Go Back</button>\n  </div>\n</div>\n\n<div class=\"row center-align\">\n  <div class=\"col s12 m12 l12 center-align\">\n    <div class=\"col s12 m6 l4\" *ngFor=\"let item of queryList; let i = index\">\n\n      <div class=\"card hoverable\">\n        <div class=\"card-content\" (click)=\"repoDetails(item)\">\n\n          <p><img class=\"quickSmallScale\" src=\"{{item.owner.avatar_url}}\" alt=\"{{item.name}}\" /></p>\n          <div class=\"content\">\n            <p><strong>{{item.name}}</strong></p>\n            <p>Owner: {{item.owner.login}}</p>\n            <p [innerHTML]=\"(item.description || 'No Description') | truncate : 150\"></p>\n          </div>\n\n        </div>\n\n        <div class=\"outGoingUp quickScale\">\n          <a href=\"{{item.html_url}}\" target=\"_blank\">\n            <i class=\"material-icons\">info</i>\n          </a>\n        </div>\n      </div>\n\n    </div>\n  </div>\n</div>\n\n\n<div class=\"search-results\"\n     infiniteScroll\n     [infiniteScrollDistance]=\"2\"\n     [infiniteScrollThrottle]=\"300\"\n     (scrolled)=\"onLoadMore(repo, page)\">\n</div>\n"
...
module.exports = __webpack_require__.p + "wall1.66fdb5574947152ab986.jpg";
...
var OrganizationDetailComponent = (function () {
    ...
    OrganizationDetailComponent.prototype.initTabs = function () {
        this.tabClosed0 = false;
        this.tabClosed1 = true;
    };
    OrganizationDetailComponent.prototype.openTab = function (tabNumber) {
        if (tabNumber == 0) {
            this.tabClosed0 = false;
            this.tabClosed1 = true;
        }
